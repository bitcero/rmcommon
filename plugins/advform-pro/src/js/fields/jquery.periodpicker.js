...
(function ($, window, document) {
    ...
    $.fn.periodpicker.defaultOptions = {
        ...
        i18n: {
            ...
            'ru' : {
                'Move to select the desired period' : 'ÐŸÐµÑ€ÐµÐ¼ÐµÑÑ‚Ð¸Ñ‚Ðµ, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð²Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð½ÑƒÐ¶Ð½Ñ‹Ð¹ Ð¿ÐµÑ€Ð¸Ð¾Ð´',
                'Select week #' : 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð½ÐµÐ´ÐµÐ»ÑŽ â„–',
                'Select period' : 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð¿ÐµÑ€Ð¸Ð¾Ð´',
                'Select date' : 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ',
                'Open fullscreen' : 'ÐžÑ‚ÐºÑ€Ñ‹Ñ‚ÑŒ Ð½Ð° Ð²ÐµÑÑŒ ÑÐºÑ€Ð°Ð½',
                'Close' : 'Ð—Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ',
                'OK' : 'OK',
                'Choose period' : 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð¿ÐµÑ€Ð¸Ð¾Ð´',
                'Choose date' : 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ð´Ð°Ñ‚Ñƒ'
            },
            'fr' : {
                'Move to select the desired period' : 'DÃ©placer pour sÃ©lectionner la pÃ©riode dÃ©sirÃ©e',
                'Select week #' : 'SÃ©lectionner la semaine #',
                'Select period' : 'Choisissez une date',
                'Select date' : 'SÃ©lectionner la date',
                'Open fullscreen' : 'Ouvrir en plein Ã©cran',
                'Close' : 'Fermer',
                'OK' : 'OK',
                'Choose period' : 'Choisir la pÃ©riode',
