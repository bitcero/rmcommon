...
(function ($) {
  ...
  $.fn.advIconPicker.populate = function (e, type) {
    ...
    if (type === 'fontawesome') {
      ...
      ele = $(e).find(".adv-icons-fa .icons-container");
      iconsLength = font_awesome.length;
      icons = font_awesome;
      prefix = 'fa';

    } else if (type === 'glyphicons') {

      ele = $(e).find(".adv-icons-glyph .icons-container");
      iconsLength = glyphicons.length;
      icons = glyphicons;
      prefix = 'glyphicon';

    } else if (type === 'icomoon') {

      ele = $(e).find(".adv-icons-icomoon .icons-container");
      iconsLength = icomoon.length;
      icons = icomoon;
      prefix = 'icon';
    ...
    for (let i = 0; i < iconsLength; i++) {
      ...
      listItems += '<li><a href="#" title="' + icons[i] + '" data-icon="' + prefix + ' ' + icons[i] + '"><span class="' + prefix + ' ' + icons[i] + '"></span></a></li>';
