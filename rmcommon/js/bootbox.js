...
window.bootbox = window.bootbox || (function init($, undefined) {
  ...
  var templates = {
    dialog:
      "<div class='bootbox modal' tabindex='-1' role='dialog' id=''>" +
  ...
  exports.dialog = function(options) {
    ...
    if (options.width) {
        dialog.find(".modal-dialog").addClass(options.width);
    }
    ...
    if (options.title) {
        if(options.icon){
            dialog.find(".modal-title").html('<i class="'+ options.icon + '"></i> ' + options.title);
        } else {
    ...
    */
    ...
    dialog.on("click", ".modal-content > .modal-footer button", function(e) {
