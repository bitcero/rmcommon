<form name="<?php echo $field; ?>_users_form">
    <div class="form-users-options">
        ...
        <div class="col-lg-3 form-group">
            ...
            <select id="<?php echo $field ?>-ord" class="form-control">
                <option value="2"<?php echo 2 == $ord ? ' selected="selected"' : ''; ?>><?php _e('ID', 'rmcommon'); ?></option>
                <option value="0"<?php echo 0 == $ord ? ' selected="selected"' : ''; ?>><?php _e('Date of register', 'rmcommon'); ?></option>
                <option value="1"<?php echo 1 == $ord ? ' selected="selected"' : ''; ?>><?php _e('Name', 'rmcommon'); ?></option>
            </select>
        </div>
    ...
    <div class="row">
                    ...
                    <ul id="<?php echo $field; ?>-selected-list">
                        <?php foreach ($selecteds as $sel): ?>
                            <li class="user_<?php echo $sel['id'] ?>">
                                <label><input type="checkbox" name="s[]" value="<?php echo $sel['id']; ?>" checked onchange="usersField.remove_from_list(<?php echo $sel['id']; ?>);">
        ...
        <div class="<?php echo 'checkbox' == $field_type ? 'col-lg-7' : 'col-lg-12'; ?>">
