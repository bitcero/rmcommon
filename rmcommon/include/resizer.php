...
/**
 * For XOOPS and Common Utilities
 */
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', XOOPS_CACHE_PATH . '/resized');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
