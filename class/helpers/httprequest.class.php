...
class RMHttpRequest
{
  ...
  protected static function get_http_parameter($method, $key, $type, $default = '')
  {
    ...
    if ('' == $type) {
      trigger_error(__('Get values from URL parameters without specify a valid type, can result in security issues. Please consider to specify a type before to get URL params.', 'rmcommon'), E_USER_WARNING);
    }
