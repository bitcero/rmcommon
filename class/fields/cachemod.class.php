...
class RMFormCacheModuleField extends RMFormElement
{
  ...
  {
    $moduleHandler = xoops_getHandler('application');
    $modules = $moduleHandler->getObjects(new Criteria('hasmain', 1), true);
    $options = ['0' => _NOCACHE, '30' => sprintf(_SECONDS, 30), '60' => _MINUTE, '300' => sprintf(_MINUTES, 5), '1800' => sprintf(_MINUTES, 30), '3600' => _HOUR, '18000' => sprintf(_HOURS, 5), '86400' => _DAY, '259200' => sprintf(_DAYS, 3), '604800' => _WEEK];
