...
//require_once LITHIUM_PATH . '/class/LithiumHelper.php';
...
$this->add_style('lithium.css', 'lithium', ['id' => 'lithium-css', 'directory' => 'assets'], 'theme');
...
$lithiumStyles = $this->get_styles(true);
...
if ('' == $logoLithium) {
    $logoLithium = LITHIUM_URL . '/assets/images/logo-li.svg';
}
