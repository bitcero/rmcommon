...
<div class="floatleft">
    <img class="cursorpointer" onclick="system_moduleLargeView();" src="<{xoAdminIcons view_large.png}>" alt="<{$smarty.const._AM_SYSTEM_MODULES_VIEWLARGE}>" title="<{$smarty.const._AM_SYSTEM_MODULES_VIEWLARGE}>">
...
<table class="outer" cellspacing="1">
    ...
    <tbody>
        ...
        <tr class="txtcenter <{cycle values='odd, even'}>">
            ...
            <td><{$row.version}></td>
            <td class="xo-modsimages">
                <a  href="<{$xoops_url}>/modules/system/admin.php?fct=modulesadmin&amp;op=install&amp;module=<{$row.dirname}>" title="<{$smarty.const._AM_SYSTEM_MODULES_INSTALL}>">
