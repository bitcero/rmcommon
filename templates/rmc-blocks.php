...
<div role="tabpanel">
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation">
            <a href="#positions" aria-controls="positions" role="tab"
               data-toggle="tab"><?php _e('Positions', 'rmcommon'); ?></a>
        </li>
...
<div id="settings-loading"><img src="images/loadinga.gif" width="16" height="16"
                                alt="<?php _e('Loading', 'rmcomon'); ?>"><?php _e('Loading data...', 'rmcommon'); ?>
</div>
