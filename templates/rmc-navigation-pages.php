<div class="pagination-container">
    <ul class="pagination">
        ...
        <?php if($current_page>1): ?>
            <li><a href="<?php echo str_replace('{PAGE_NUM}', $current_page-1, $url); ?>" title="<?php _e('Previous Page','rmcommon'); ?>"><?php _e('&laquo;','twop6'); ?></a></li>
        <?php endif; ?>
        ...
        <?php if($current_page<$total_pages): ?>
            <li><a href="<?php echo str_replace('{PAGE_NUM}', $current_page+1, $url); ?>" title="<?php _e('Next Page','rmcommon'); ?>"><?php _e('&raquo;','twop6'); ?></a></li>
        <?php endif; ?>

        <?php if($total_pages>$steps && $current_page<($total_pages-$steps)+2): ?>
            <li><a href="<?php echo str_replace('{PAGE_NUM}', $total_pages, $url); ?>" title="<?php _e('Last Page','rmcommon'); ?>"><?php _e('Last','twop6'); ?></a></li>
        <?php endif; ?>
    </ul>
</div>