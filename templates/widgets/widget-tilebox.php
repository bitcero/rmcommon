<div <?php echo $attributes; ?>>
    ...
    <?php else: ?>
        ...
        <!-- Counter -->
        <?php if($settings->style != 'progress' && '' == $settings->link): ?>
        <div class="icon"><?php echo $cuIcons->getIcon($settings->icon . ($settings->solid != true && $settings->color != '' ? ' text-' . $settings->color : '')); ?></div>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <div class="caption <?php if($settings->solid != true && $settings->color != ''): ?>text-<?php echo $settings->color; ?><?php endif; ?>"><?php echo $settings->caption; ?></div>
        <div class="counter"><?php echo $settings->counter; ?></div>

        <?php if($settings->style == 'progress'): ?>
        <div class="progress">
