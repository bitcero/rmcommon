        ...
        <div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="btn-group pull-right">
                    <button type="button" class="btn btn-default" onclick="loadUpdateDetails(<?php echo $i; ?>);"><i class="icon-info-sign"></i> <?php _e('View details','rmcommon'); ?></button>
                    <button type="button" class="btn btn-default" onclick="installUpdate(<?php echo $i; ?>);" data-id="<?php echo $i; ?>"><i class="icon-circle-arrow-down"></i> <?php _e('Update now!','rmcommon'); ?></button>
                    <button type="button" class="btn button-default btn-warning" onclick="installLater(<?php echo $i; ?>);" data-id="<?php echo $i; ?>"><i class="icon-time"></i> <?php _e('Install Later','rmcommon'); ?></button>
                </div>
            </div>
        </div>
    </div>
