                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="url" id="user-url" size="20"
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="from" id="user-from" size="20"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control inline" name="posts1" id="users-posts1"
                                               value="<?php echo (int)$srhposts1; ?>" size="5">
                                      <?php _e('and', 'rmcommon'); ?>
                                        <input type="text" class="form-control inline" name="posts2" id="users-posts2"
                                               value="<?php echo (int)$srhposts2 > 0 ? (int)$posts2 : ''; ?>" size="5">
                                    </div>
                                </div>
                    ...
                    <?php _e('All these options are optional and will be additional to basic search keyword.', 'rmcommon'); ?>
                                ...
                                <div class="col-md-8 col-lg-8 text-right">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="button" onclick="$('#users-advanced-options').slideUp('slow');"
            ...
            <div class="cu-bulk-actions">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-9">
                        ...
                        <button type="button" onclick="before_submit('form-users');" class="btn btn-default"
            ...
            <div class="cu-bulk-actions visible-md visible-lg">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <button type="button" onclick="before_submit('form-users');" class="btn btn-default"
                                id="the-op-bottom"><?php _e('Apply', 'rmcommon'); ?></button>
                    </div>
                </div>
